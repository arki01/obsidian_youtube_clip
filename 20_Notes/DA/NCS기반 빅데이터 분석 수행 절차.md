...
# 개요
NCS(국가직무능력표준) 기반 빅데이터 분석 절차에 대해서 자세히 설명한다.
추가적인 이론들은 계속해서 업데이트 해나가면서 완성 시키도록 하자. 

# 내용
#### 빅데이터 분석요건 정의하기
- 도메인 이슈 및 조직의 비지니스 요구사항을 정의한다.
- 요구사항에 적합한 분석 기회를 발굴하고 구조화한다.
- 구조화된 분석 기회를 평가하여 분석 주제를 선정한다.
...
- 데이터 분석 결과 해석에 따른 비지니스 실행 방안을 수립하고, 실무 적용을 위한 분석 결과 전개 방안을 수립한다.
